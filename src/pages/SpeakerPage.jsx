...
function SpeakerPage() {
  ...
  const groupedSpeakers = useMemo(() => {
    ...
    return Object.values(groups)
      ...
      .map((group) => ({
        ...group,
        speakers: group.speakers.sort((a, b) => a.pageOrder - b.pageOrder),
      }));
  }, []);
  ...
  return (
    <>
      {/* <InnerPageHero
        title="Our Speakers"
      /> */}
      <section ref={sectionRef} id="speakers" className="pt-30 py-20 hidden">
          ...
          {groupedSpeakers.map((group) => (
            <div key={group.category} className="mb-20 last:mb-0">
              ...
              <div className="mb-10 text-center">
                <div className="subtitle">Distinguished Faculty</div>
